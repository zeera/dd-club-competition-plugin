...
class TicketNumber extends TableHelper
{
    ...
    public function getSearchVars()
    {
        return [
            ...
            'ticket_number' => ['Ticket Number', 'like', $this->tableName],
    ...
    {
        $ticketData = $this->queryWp("SELECT * FROM `#prefix_ticket_numbers` WHERE `product_id` = '%s'", [$productID]);
        return $ticketData;
    }
    ...
    public function deleteTicketByOrderNumber($order_id) {
        $ticketData = $this->queryWp("DELETE FROM `#prefix_ticket_numbers` WHERE `order_id` = '%s'", [$order_id]);
        return $ticketData;
    }
}
