...
class Loader
{
    ...
    public static function initAdminPages()
    {
        ...
        if( $adminHelper->isAdmin() ) {
            ...
            add_submenu_page(WPDIGITALDRIVE_COMPETITIONS_NAMESPACE, __("Cash Sales"), __("Cash Sales"), "administrator", WPDIGITALDRIVE_COMPETITIONS_NAMESPACE . "_cash_sales", [self::class, "menuCashSales"]);
        }
     ...
     * Cash Sales
     */
    public static function menuCashSales()
    {
